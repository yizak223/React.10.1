...
function Images(props) {
    ...
    return (
        <div>
            ...
            <button onClick={()=>{setCount('https://media.istockphoto.com/id/546208904/photo/milky-way-at-pigeon-point-lighthouse-pescadero-california.jpg?s=2048x2048&w=is&k=20&c=7KDP1S1O2IcERLlxxaAb2sEikt7J9khhjR0_0nQ9GtI=')}}>
            ...
            <button onClick={()=>{setCount('https://media.istockphoto.com/id/1286897582/photo/the-lighthouse-at-norah-head-on-the-central-coast-in-regional-new-south-wales-in-australia.jpg?s=2048x2048&w=is&k=20&c=NzB5MHjC2RSNw6CltMbe2FhbDlCqDh4f2_qx_2MpeCQ=')}}>
            ...
            <button onClick={()=>{setCount('https://media.istockphoto.com/id/971567440/photo/near-and-far.jpg?s=2048x2048&w=is&k=20&c=Eqfzl0rdEnHJLRR5Yw6Xpen5T8sryU2x8n9jcHwcqjQ=')}}>
